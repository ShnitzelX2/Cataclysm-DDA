 ...
 * Currently a composite of generic_factory<itype>, which does most of the loading.
 * Contains all item groups that are used to spawn items.
 *
 * Functionally a singleton class; use the single global instance `item_factory`.
 */
class Item_factory
{
