...
void game_ui::print_all_tile_info( const tripoint_bub_ms &lp, const catacurses::window &w_look,
...
void game_ui::print_visibility_info( const catacurses::window &w_look, int column, int &line,
...
void game_ui::print_terrain_info( const tripoint_bub_ms &lp, const catacurses::window &w_look,
...
void game_ui::print_furniture_info( const tripoint_bub_ms &lp, const catacurses::window &w_look,
                                    int column,
                                    int &line )
{
    map &here = get_map();
...
void game_ui::print_fields_info( const tripoint_bub_ms &lp, const catacurses::window &w_look,
                                 int column,
                                 int &line )
{
    map &here = get_map();
...
void game_ui::print_trap_info( const tripoint_bub_ms &lp, const catacurses::window &w_look,
                               const int column,
                               int &line )
{
    map &here = get_map();
...
void game_ui::print_part_con_info( const tripoint_bub_ms &lp, const catacurses::window &w_look,
                                   const int column,
                                   int &line )
{
    map &here = get_map();
...
void game_ui::print_creature_info( const Creature *creature, const catacurses::window &w_look,
...
void game_ui::print_vehicle_info( const vehicle *veh, int veh_part,
...
void game_ui::print_items_info( const tripoint_bub_ms &lp, const catacurses::window &w_look,
                                const int column,
                                int &line,
                                const int last_line )
{
...
void game_ui::print_graffiti_info( const tripoint_bub_ms &lp, const catacurses::window &w_look,
...
void game_ui::print_debug_info( const tripoint_bub_ms &lp, const catacurses::window &w_look,
                                const int column, int &line )
{
    if( debug_mode ) {
        const map &here = get_map();
...
void game_ui::pre_print_all_tile_info( const tripoint_bub_ms &lp, const catacurses::window &w_info,
